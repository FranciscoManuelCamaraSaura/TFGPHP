		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<button id="sendMessageButton" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="right" title="Enviar mensaje" onclick="sendMessage('{{ $school }}', '{{ $person -> id }}', '', '{{ $student -> id }}', '{{ $type_user }}', '2')">
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-4">
							<label id="firstTrimesterTitle">Nota media primer trimestre</label>
						</div>

						<div class="col-md-4">
							<label id="secondTrimesterTitle">Nota media segundo trimestre</label>
						</div>

						<div class="col-md-4">
							<label id="thirdTrimesterTitle">Nota media tercer trimestre</label>
						</div>
					</div>
				</div>
			</div>

			@foreach($evaluation as $subject)
				<div class="row">
					<div class="col-md-1">
					</div>
					...
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-4">
								<label>{{ $subject['noteFirstTrimester'] }}</label>
							</div>

							<div class="col-md-4">
								<label>{{ $subject['noteSecondTrimester'] }}</label>
							</div>

							<div class="col-md-4">
								<label>{{ $subject['noteThirdTrimester'] }}</label>
							</div>
						</div>
					</div>
				</div>
